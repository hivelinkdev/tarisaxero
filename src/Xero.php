...
namespace Tarisaxero\Xero;

use Tarisaxero\Xero\Models\XeroToken;
use Tarisaxero\Xero\Resources\Contacts;
use Tarisaxero\Xero\Resources\Invoices;
use Tarisaxero\Xero\Resources\Webhooks;
...
class Xero
{
    ...
    protected function storeToken($token, $tenantData = null)
    {
        ...
        return XeroToken::updateOrCreate(['company_id' => $company_id], $data);
    }
